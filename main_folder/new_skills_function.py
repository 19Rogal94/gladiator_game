...
def new_skills_choice(skill_point, gladiator: UserGladiator):
    ...
    while skill_point_1 < skill_point:
        ...
        if user_choice == 1:
            ...
            print(f"Podałeś złą wartość, wprowadź ponownie poprawną\n")
            continue
